...
import { faGithubSquare, faLinkedinIn, faFacebookSquare, faMedium, } from '@fortawesome/free-brands-svg-icons';
...
const AllLink = () => {
    return (
        <div className="col-md-4 pt-4">
            <h3 style={{color:"#2596be" }}>Where To Find Me?</h3>
            <p>Do you have an interesting project I can help with? Feel free to reach out to me by using one of the following:</p>

            <p><FontAwesomeIcon style={{color: "#2596be" }} className="icon active-icon" icon={faMapMarkerAlt} /> Address: 40/41, C, Zindabahar 1st lane, Dhaka-1100</p>
            <p><FontAwesomeIcon style={{color: "#2596be" }}  className="icon active-icon" icon={faPhoneAlt} /> Mobile: 01989980906</p>
            <p><FontAwesomeIcon style={{color: "#2596be" }}  className="icon active-icon" icon={faEnvelope} /> Email: jakhi161265@bscse.uiu.ac.bd</p>
